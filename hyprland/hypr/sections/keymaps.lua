...
hl.bind(ctrl_mod .. " + h", hl.dsp.window.resize({ x = -20, y = 0 }))
hl.bind(ctrl_mod .. " + l", hl.dsp.window.resize({ x = 20, y = 0 }))
hl.bind(ctrl_mod .. " + k", hl.dsp.window.resize({ x = 0, y = -20 }))
hl.bind(ctrl_mod .. " + j", hl.dsp.window.resize({ x = 0, y = 20 }))

-- Resize active window (Arrow Keys)
hl.bind(ctrl_mod .. " + left", hl.dsp.window.resize({ x = -20, y = 0 }))
hl.bind(ctrl_mod .. " + right", hl.dsp.window.resize({ x = 20, y = 0 }))
hl.bind(ctrl_mod .. " + up", hl.dsp.window.resize({ x = 0, y = -20 }))
hl.bind(ctrl_mod .. " + down", hl.dsp.window.resize({ x = 0, y = 20 }))
